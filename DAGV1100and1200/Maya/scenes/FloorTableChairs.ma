...
//Last modified: Fri, Mar 06, 2026 10:35:03 PM
//Codeset: 1252
...
fileInfo "UUID" "89A2F06E-46AF-FC4F-31EB-B5A294F7A8E3";
createNode transform -s -n "persp";
	rename -uid "796F2A5A-44C0-B29F-B54E-8A85EBEAAC0B";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.6101225875155438 13.078411124669671 22.95125421934047 ;
	setAttr ".r" -type "double3" -384.93835266686204 6.9999999999993872 6.0083251724693005e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "3B375EFB-4783-CD5F-AB83-859E758FCEA3";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 25.30216083571036;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "AEC964F9-4083-9527-F9B3-7EB74145DEA2";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "9FC6D633-4E94-A351-7646-979DF812A95A";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "AD1BFBDE-49B6-224A-A652-9AA40E8CAFCF";
createNode displayLayerManager -n "layerManager";
	rename -uid "4CEBA009-43AB-687A-9D9E-C8BA0BB7A6E6";
createNode displayLayer -n "defaultLayer";
	rename -uid "10EE0328-4640-139F-B445-AD95C8DA1B65";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "66FFC411-4E9B-4DD1-6FEF-C1A43DBD4016";
...
createNode reference -n "lampRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"lampRN" 0
		"lampRN" 15
		2 "|lamp:Lamp_1" "translate" " -type \"double3\" 0.45953830075506819 0.15375030591999117 0"
...
createNode reference -n "CouchRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"CouchRN" 0
		"CouchRN" 15
		2 "|Couch:Couch" "translate" " -type \"double3\" -3.77475712256168006 -0.33984304565060519 -4.68483330999887215"
