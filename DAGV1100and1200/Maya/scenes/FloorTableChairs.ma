...
//Last modified: Thu, Jan 22, 2026 12:03:11 PM
//Codeset: 1252
requires maya "2026";
requires "mtoa" "5.5.3";
...
fileInfo "UUID" "3A08D67D-4632-3CA5-6A26-D28D880C91CD";
createNode transform -s -n "persp";
	rename -uid "796F2A5A-44C0-B29F-B54E-8A85EBEAAC0B";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.2300130257934399 5.0916335525019818 11.817832284278431 ;
	setAttr ".r" -type "double3" -19.538352730697643 383.79999999979509 -1.7380846354314584e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "3B375EFB-4783-CD5F-AB83-859E758FCEA3";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 13.202362890541353;
...
createNode transform -n "pCube1";
	rename -uid "71E207EC-4A0A-A4EE-2A3C-A39360085191";
	setAttr ".t" -type "double3" -4.0139492920021329 1.737367504214459 0.082663096299450345 ;
	setAttr ".s" -type "double3" 2.1467239130669844 2.1467239130669844 2.1467239130669844 ;
createNode mesh -n "pCubeShape1" -p "pCube1";
	rename -uid "034F7F4F-4D6F-C60B-C5F1-DBBD0B054A1B";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 8 ".pt[0:7]" -type "float3"  0.34935078 -0.19871162 0.26671347 
		-0.3848362 -0.19871162 0.26671347 0.34935078 0.19871162 0.26671347 -0.3848362 0.19871162 
		0.26671347 0.34935078 0.19871162 -0.26671347 -0.3848362 0.19871162 -0.26671347 0.34935078 
		-0.19871162 -0.26671347 -0.3848362 -0.19871162 -0.26671347;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "E18FC50F-4AC2-7DBF-9C5C-2D927A870755";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "47363183-4520-F7B6-EB01-C882EFAE1600";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "EC807CC6-4137-5B94-A117-FD84636E58BC";
createNode displayLayerManager -n "layerManager";
	rename -uid "05063403-4BBD-9399-B670-3988B790AF8D";
createNode displayLayer -n "defaultLayer";
	rename -uid "10EE0328-4640-139F-B445-AD95C8DA1B65";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "18833A93-4837-F789-E381-CB9CA0268C12";
...
createNode polyCube -n "polyCube4";
	rename -uid "BD9E60BD-4990-DCB9-F9A7-B1A210766013";
	setAttr ".cuv" 4;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
