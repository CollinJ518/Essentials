...
//Last modified: Wed, Apr 01, 2026 02:52:22 PM
//Codeset: 1252
requires maya "2026";
...
fileInfo "UUID" "E33E0409-46C8-92ED-F391-A994EB3C35BB";
createNode transform -s -n "persp";
	rename -uid "9500C114-4B01-0266-A6E7-BEB9E859385F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -6.4375503974712736 11.900069878004009 23.03001184389586 ;
	setAttr ".r" -type "double3" -20.13835277487944 341.80000000004713 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "98DBEB5A-4C79-00CA-C196-1983C242C279";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 18.021168624831891;
...
createNode transform -n "pCube7";
	...
	setAttr ".r" -type "double3" 0 -25.982847603794458 0 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "F9F57F28-40EF-B6B4-9EBC-43831A1D4EDA";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "E234BBF0-4509-E556-15FB-04B361C12C26";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "2C292690-4674-36D9-DCDD-B4BF2EE5402A";
createNode displayLayerManager -n "layerManager";
	rename -uid "B9A28254-4C52-F607-4D0E-93A749A9596C";
createNode displayLayer -n "defaultLayer";
	rename -uid "3897D56C-435E-8C47-F937-06995E6CA199";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "40C28738-431B-84BB-7733-C4B7172DBD07";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "4AC873A7-4BD1-7554-EC71-0A87AB08384D";
	setAttr ".g" yes;
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "E11426FD-4114-6C55-CCC6-AB8651A9D848";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -44.047617297323995 -902.38091652355649 ;
	setAttr ".tgi[0].vh" -type "double2" 986.90472268869166 44.047617297323995 ;
